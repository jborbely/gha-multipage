...
<!--
  The starting point for this XSL file was taken from
  https://github.com/Mapudo/xs3p

  It is a fork of version 1.1.5 of the xs3p doc tool from http://xml.fiforms.org/xs3p/
  with new features:
  - Bootstrap HTML toolkit
  - Output of UTF-8 encoded files
  - Output of HTML5
  - Markdown formatting support in <documentation> elements, powered by markdown-it
